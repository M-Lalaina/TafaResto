...
class DishesController extends AbstractController
{
    ...
    public function new(Request $request, DishesRepository $dishesRepository, FileUploader $fileUploader): Response
    {
        $dish = new Dishes();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($coverImage) {
                $imagesFileName = $fileUploader->upload($coverImage);
                $dish->setCoverImage($imagesFileName);
    ...
    public function edit(Request $request, Dishes $dish, DishesRepository $dishesRepository, FileUploader $fileUploader): Response
    {
        $form = $this->createForm(DishesType::class, $dish);
        $form->handleRequest($request);
